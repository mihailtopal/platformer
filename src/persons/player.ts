...
// export class Player_1 extends Phaser.Physics.Arcade.Sprite {
//   stand_height: number;
...
//       if (
//         animation.key === `shield_bash_1` ||
//         animation.key === `attack_${this.attackCombo}`
//       ) {
...
//       .setSize(70, 50); // Настраиваем размеры hitbox
//
...
//
//     this.comboInterval++;
//     console.log(this.distanceToTheCeiling, this.isSit);
//   }
//   hitEnemy(hitBox: Body, enemy: Creature) {
//     // Здесь можно добавить логику нанесения урона
//     enemy.takeDamage(this.attackDamage); // Примерный метод нанесения урона
//   }
//   attackHitBoxUpdate() {
